...
- Improving my understanding of design patterns and core data structures in real projects  
...
Focus: maintainable gameplay systems.

### VeilTempo (Game Jam)
Rhythm prototype using `AudioSettings.dspTime` for accurate note timing.
